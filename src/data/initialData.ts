...
export const OPERATION_GROUPS = [
  { id: '6-1', name: 'กลุ่มงานปฏิบัติการเดินรถที่ 1 (กปด.16)', depot: 'อู่ไร่ขิง' },
  { id: '6-2', name: 'กลุ่มงานปฏิบัติการเดินรถที่ 2 (กปด.26)', depot: 'อู่พุทธมณฑลสาย 3' },
  { id: '6-3', name: 'กลุ่มงานปฏิบัติการเดินรถที่ 3 (กปด.36)', depot: 'อู่พุทธมณฑลสาย 3' }
];

export const POPULAR_ROUTES = [
  { route: '84', name: 'อู่ไร่ขิง - คลองสาน', defaultBus: '6-55012' },
  { route: '515', name: 'อู่สายใต้ - อนุสาวรีย์ชัยสมรภูมิ', defaultBus: '6-56024' },
  { route: '509', name: 'อู่พุทธมณฑลสาย 3 - หมอชิต 2', defaultBus: '6-55048' },
  { route: '556', name: 'อู่ไร่ขิง - สถานีรถไฟมักกะสัน', defaultBus: '6-55030' },
  { route: '511', name: 'อู่สายใต้ - ปากน้ำ (ทางด่วน/ธรรมดา)', defaultBus: '6-50212' },
  { route: '79', name: 'อู่พุทธมณฑลสาย 2 - ราชประสงค์', defaultBus: '6-55018' },
  { route: '101', name: 'อู่พุทธมณฑลสาย 2 - ตลาดพลู', defaultBus: '6-50120' },
  { route: '80', name: 'วัดศรีนวลฯ - สนามหลวง', defaultBus: '6-55010' },
  { route: '84ก', name: 'วงเวียนใหญ่ - ม.มหิดล ศาลายา', defaultBus: '6-50192' }
];
